...
.state("animaltree",{
    url: "/animaltree",
    templateUrl: "./views/animal-tree/animaltree.html",
    controller: "animaltreeControl"
    })
    .state("animaltree.intro",{
    url: "/welcome",
    templateUrl: "./views/animal-tree/at-welcome.html",
    controller: "animaltreeControl"
    })
    .state("animaltree.amphibian",{
    url: "/amphibian",
    templateUrl: "./views/animal-tree/at-amphibian.html",
    controller: "atamphibianControl"
    })
    .state("animaltree.arthropod",{
    url: "/arthropod",
    templateUrl: "./views/animal-tree/at-arthropod.html",
    controller: "atarthropodControl"
    })
    .state("animaltree.birds",{
    url: "/birds",
    templateUrl: "./views/animal-tree/at-bird.html",
    controller: "atbirdsControl"
    })
    .state("animaltree.fish",{
    url: "/fish",
    templateUrl: "./views/animal-tree/at-fish.html",
    controller: "atfishControl"
    })
    .state("animaltree.mammals",{
    url: "/mammals",
    templateUrl: "./views/animal-tree/at-mammals.html",
    controller: "atmammalsControl"
    })
    .state("animaltree.reptiles",{
    url: "/reptiles",
    templateUrl: "./views/animal-tree/at-reptiles.html",
    controller: "atreptilesControl"
    })
.state("identify",{
    url: "/identify",
